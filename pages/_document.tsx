    ...
    return (
      <Html>
        <Head>
          ...
          {((this.props as any).pathname as string).startsWith("/menu") && <script src={`https://maps.googleapis.com/maps/api/js?key=${process.env.NEXT_PUBLIC_REACT_APP_GOOGLE_MAPS_API_KEY}&libraries=places`}></script>}
        </Head>
        <body>
          <Main />
          <NextScript />
