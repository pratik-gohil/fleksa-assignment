import { INodeApiHttpPostLoginRequestData, INodeApiHttpPostLoginResponse } from '../../../interfaces/http/nodeapi/login/post.login.nodeapi.http';
...
export default class NodeApiHttpPostLogin extends ApiHttpCommon {
  public async post({ countryCode, phone, shopId, languageCode }: INodeApiHttpPostLoginRequestData) {
    try {
