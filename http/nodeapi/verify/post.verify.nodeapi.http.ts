import { INodeApiHttpPostVerifyRequestData, INodeApiHttpPostVerifyResponse } from '../../../interfaces/http/nodeapi/verify/post.verify.nodeapi.http';
...
export default class NodeApiHttpPostVerify extends ApiHttpCommon {
  public async post({ otp, shopId, customerId, languageCode }: INodeApiHttpPostVerifyRequestData) {
    try {
